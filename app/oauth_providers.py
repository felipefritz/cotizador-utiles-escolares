...
TWITTER_CLIENT_ID = os.getenv("TWITTER_CLIENT_ID", "TU_TWITTER_CLIENT_ID")
TWITTER_CLIENT_SECRET = os.getenv("TWITTER_CLIENT_SECRET", "TU_TWITTER_CLIENT_SECRET")
TWITTER_REDIRECT_URI = os.getenv("TWITTER_REDIRECT_URI", "http://localhost:8000/api/auth/twitter/callback")

GITHUB_CLIENT_ID = os.getenv("GITHUB_CLIENT_ID", "TU_GITHUB_CLIENT_ID")
GITHUB_CLIENT_SECRET = os.getenv("GITHUB_CLIENT_SECRET", "TU_GITHUB_CLIENT_SECRET")
