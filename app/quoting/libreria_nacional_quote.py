    ...
    def _parse_results(self, html: str, query: str, limit: int) -> List[Dict[str, Any]]:
        ...
        for card in cards:
            ...
            try:
                ...
                # URLs a evitar
                if any(x in url_lower for x in ["pages", "blog", "login", "cart", "/collections/", "policy", "terms", "#", "facebook", "instagram", "twitter", "youtube"]):
                    continue
                ...
                # Textos a evitar (productos malos)
                if any(x in text_lower for x in ["hojas", "páginas", "política", "términos", "ayuda", "contacto", "@", "oferta flash", "oferta", "promoción", "por compras", "lleva un"]):
                    continue
    ...
    def _parse_collection(self, html: str, search_term: str, limit: int) -> List[Dict[str, Any]]:
        ...
        for card in cards:
            ...
            try:
                ...
                # Filtrar productos malos por nombre
                if any(x in text_lower for x in ["hojas", "páginas", "política", "términos", "ayuda", "contacto", "oferta flash", "oferta", "promoción", "por compras", "lleva un"]):
                    continue
